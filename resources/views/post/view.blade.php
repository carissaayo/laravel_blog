<x-app-layout>
        ...
        <section class="w-full md:w-2/3 flex flex-col items-center px-3">
            ...
            <div class="w-full flex pt-6">
                <div class="w-1/2">
                    @if ($prev)
                    <a href= "{{ route('view', $prev) }}" class=" bg-white shadow hover:shadow-md text-left p-6 ">
                        <p class="text-lg text-blue-800 font-bold flex items-center"><i class="fas fa-arrow-left pr-1"></i> Previous</p>
                        <p class="pt-2 pl-6">{{ Str::words($prev->title , 5, '...') }}</p>
                ...
                <div class="w-1/2">
                    ...
                    <a href="{{ route('view',$next) }}" class=" bg-white shadow hover:shadow-md text-right p-6">
